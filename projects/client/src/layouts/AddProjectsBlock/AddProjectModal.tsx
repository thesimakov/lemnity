      ...
      <div className="flex flex-col p-4.5 gap-2.5 border border-gray-200 rounded-[14px]">
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <Input
            ...
            className="w-full"
            radius="sm"
            endContent={<CustomSwitch isSelected={isEnabled} onValueChange={setIsEnabled} size="sm"/>}
            value={websiteUrl}
            onChange={(e) => setWebsiteUrl(e.target.value)}
          />
          <span className="text-gray-400 text-xs">Если сайт проекта выключен, то вы не сможете увидеть аналитику</span>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-2">
          <h2 className="font-roboto font-semibold text-4xl tracking-[0.01em]">Добавление проекта</h2>
          <span className="text-base text-gray-600">Создайте всплывающее окно в стиле вашего бренда. Показывайте его нужной аудитории в подходящий момент, используя триггеры и правила таргетинга</span>
        </div>
        <button
          onClick={onClose}
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-5xl w-full max-h-[90vh] overflow-hidden">
        <div className="flex h-full">
          <div className="flex-shrink-0 w-2/5 bg-gray-50 flex items-center justify-center">
            <img src={imageAddProject} alt="add-project" className="max-w-full max-h-full object-contain" />
          </div>
