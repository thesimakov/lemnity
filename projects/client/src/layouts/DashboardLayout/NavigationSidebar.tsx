...
const getFooter = () => (
  <div className="rounded-lg border border-default-200 flex flex-col justify-between gap-3.5 pt-1.5 p-3.5">
        <div className="flex items-center gap-3.5">
          <div className="flex-1 bg-gray-200 rounded-lg relative p-3.5 gap-3.5">
            <p className="text-sm font-normal text-default-900 text-center">
              Ваш менеджер
            </p>
            <p className="text-sm font-semibold text-default-900 text-center">
              Иван Иванов
            </p>
  ...
  return (
    <aside className="w-60 h-full flex flex-col justify-between py-[18px] px-[19px] rounded-l-lg sidebar-bg">
      ...
      <a href="https://help.lemnity.ru" target="_blank" className="gap-2 flex flex-row justify-center mt-auto mb-2.5">
        <div>
