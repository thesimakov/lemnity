...
const ProjectRow = ({ id, name, enabled, visitors, impressions, conversions, activityPercent }: ProjectRowProps) => {
    ...
    >
      <div className="grid grid-cols-12 items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-row items-center justify-start gap-4 mt-2.5">
              <div className="relative z-10 child">
                ...
                <Dropdown >
              <DropdownTrigger >
                <Button isDisabled={!enabled} size="sm" variant="flat">Редактировать</Button>
              </DropdownTrigger>
        ...
        <div className="col-span-8 grid grid-cols-4 gap-2">
          <MetricCard value={visitors.desktop + visitors.mobile} desktop={visitors.desktop} mobile={visitors.mobile} />
          <MetricCard value={impressions.desktop + impressions.mobile} desktop={impressions.desktop} mobile={impressions.mobile} />
          <MetricCard 
            value={(Math.round(1000*visitors.desktop/impressions.desktop)/10 + Math.round(1000*visitors.mobile/impressions.mobile)/10)/2} 
            ...
            isPercent={true} />
          <MetricCard  value={activityPercent} pillColor="bg-green-100 text-green-700" isPercent={true} />
        </div>
      </div>
    </div>
  );
