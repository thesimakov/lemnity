...
import type { FormSettings } from '@/stores/widgetSettings/types'
import type { FormActions } from '@/stores/widgetSettings/formSlice'

type UseFormSettingsReturn = {
  settings: FormSettings
} & FormActions

export const useFormSettings = (): UseFormSettingsReturn => {
